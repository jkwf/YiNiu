...
- (void)refreshData{
    ...
    [WebShareData getDataFromWebWithParams:@{@"Phone":LoginUserName} urlString:@"http://120.27.157.147/Web/easytrader.joysw.cn/yn_friend/index.php?mod=interface&ac=myclist" successBlock:^(NSDictionary *dicInfo) {
        NSLog(@"-------------------%@",dicInfo);
