...
@interface ReadingViewController()<WKNavigationDelegate>
...
-(void)viewDidLoad
{
    ...
    NSURL *URL = [NSURL URLWithString:[NSString stringWithFormat:@"http://easytrader.joysw.cn/shejiao/html/bookshelf.html"]];
