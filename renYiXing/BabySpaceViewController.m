...
@interface BabySpaceViewController()<WKNavigationDelegate>
...
@implementation BabySpaceViewController
-(void)viewDidLoad
{
...
//    self.navigationItem.leftBarButtonItem = leftBarButton;
    ...
    NSURL *URL = [NSURL URLWithString:[NSString stringWithFormat:@"http://easytrader.joysw.cn/baby_space/index.php?mod=news"]];
