...
@interface TrainingVideoViewController()<WKNavigationDelegate>
...
//    //    self.navigationController.navigationBar.barTintColor= [UIColor blackColor];
    ...
    NSURL *URL = [NSURL URLWithString:[NSString stringWithFormat:@"http://easytrader.joysw.cn/baby_space/index.php?mod=news&ac=video"]];
   // NSURL *url=[NSURL URLWithString:@"http://easytrader.joysw.cn/index.php?mod=news&ac=video&cid=11"];
