...
@interface VirtualGoldViewController()
@property(nonatomic , strong)UILabel *balanceLabel;
@property(nonatomic , strong)UILabel *canBalanceLabel;
@end

@implementation VirtualGoldViewController
-(void)viewDidLoad
{
    ...
    [changeBtn setTitle:@"兑换" forState:UIControlStateNormal];
    [changeBtn setTitleColor:[UIColor colorWithRed:53/255.0 green:154/255.0 blue:204/255.0 alpha:1.0] forState:UIControlStateNormal];
    changeBtn.backgroundColor = [UIColor colorWithRed:49/255.0 green:54/255.0 blue:59/255.0 alpha:1.0];
